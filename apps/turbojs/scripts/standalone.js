...
// See the public TurboJS runtime header.
...
/**
 * Trailer for standalone binaries. When code is bundled with the TurboJS CLI
...
export function runStandalone() {
  ...
  // Shouldn't happen since apps/turbojs/main.c checks for it.
